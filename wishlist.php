...
$sql_count = "SELECT COUNT(*) as total FROM tailieuyeuthich where tailieuyeuthich.userid = '$user_id'; ";
...
from tailieu join 
tailieuyeuthich on tailieuyeuthich.tailieuid = tailieu.id where tailieuyeuthich.userid = '$user_id'
...
<div class= "bgtext" style = " margin-top:10px;height : 100px; max - width : 100vw; background: #4CC082; 
    display: flex; align-items: center; justify-content: center">
      <!-- <img src="images/bgtext.jpg" alt="" style = "height : 150px; width : 100vw" > -->
       <p style = "font-size : 30px; font-weight: bold">Tài liệu yêu thích</p>
    </div>
